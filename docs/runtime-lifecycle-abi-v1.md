...
aggregate ABI tracked by #1439. The generic owned.move_state row stays partial
until #1438 covers unsupported shapes, including unsized moves; this does not
define general aggregate layout,
