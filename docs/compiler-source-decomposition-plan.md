...
to `project.rs` and deterministic document, link, search, and doctest
orchestration to `main.rs`. The ceiling update below records that bounded
feature growth explicitly. The next extraction for this surface is a
...
| `stage1/crates/axiomc/src/project.rs` | 11899 |
| `stage1/crates/axiomc/src/project/build_contract.rs` | 118 |
| `stage1/crates/axiomc/src/main.rs` | 10895 |
