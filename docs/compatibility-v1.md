...
Package Trust v1 schemas, eight additive base-contract schemas (Native Debug
Status v1, Native Debugging v1, Provider ABI, runtime observability, Semantic
MIR, runtime lifecycle, target support, and persistent LSP), two quality
