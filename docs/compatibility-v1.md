...
The current source contract is version `0.4.0` with 69 surfaces. Its changes
from the byte-frozen 52-surface `0.1.0` accepted baseline include the five
Package Trust v1 schemas, seven additive base-contract schemas (compiler native
backend/runtime, Provider ABI, runtime observability, Semantic MIR, runtime
