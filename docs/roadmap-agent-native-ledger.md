...
|---|---:|---|---|---|
| Direct native backend | #927 | #105, #627, #628, #629, #630, #652, #653, #654, #656, #691, #692, #693, #694, #928, #929, #1001 | use #927 as the readiness gate; keep #693/#694 as implementation slices | Start with the readiness matrix before backend replacement work. Do not remove generated Rust until #694 is assigned and the readiness gate is green. |
