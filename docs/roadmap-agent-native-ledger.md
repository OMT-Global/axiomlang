...
|---|---:|---|---|---|
| Direct native backend | #1124 | #105, #627-#630, #652-#656, #691-#694, #927-#929, #1191, #1255 | shipped for the supported toolchain | Keep ABI, command-surface, and full-lib evidence green; open a new regression issue rather than executing from historical backend slices. |
| Rust bootstrap removal / self-hosting | #721 | #565, #1254, #1366, #1425-#1428 | active final gate | Execute from the leaf issues. A green backend-exit gate is necessary but not sufficient for host exit. |
...
- **Backend-exit** — make `rustc`/Cargo unnecessary to build *user programs* by
  ...
  generated-Rust backend. This track is complete for the supported toolchain:
  the ABI, command-surface, full-lib triage, and live Rust-exit gates are green.
...
- **Host-exit (self-hosting)** — rewrite `axiomc` itself in AxiOM and prove a
  ...
  two AxiOM compiler spikes pass direct-native Rust parity, while the compiler
  remains two Rust crates with roughly 90k lines of hand-written Rust source.
  The leaf path is #1254 and #1425-#1428, with #721 as the final policy gate.
...
| Self-hosting language readiness | #1366 | keep open | The gate remains red on runtime-sized collections (#1425), string/slice parameter ABI (#1426), and compiler-scale proof (#1427). |
...
| Compiler-scale AxiOM proof | #1427 | ready after #1425/#1426 | Turn the command-surface and compiler-scale readiness rows green from executable multi-package evidence. |
