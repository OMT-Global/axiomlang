...
| Property testing | #715 | #560, #561, #637, #639, #640, #641, #642, #672, #676, #678, #679, #680, #706, #711, #712, #714 | supersede older phase duplicates | Use #715 for first-class property tests; use #711 only for the runner flag if assigned. #706 is the narrow property-clause syntax/type-checking slice and does not imply sampled runner completion. |
