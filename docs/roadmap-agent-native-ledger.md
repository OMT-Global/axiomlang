...
|---|---:|---|---|---|
| Direct native backend | #927 | #105, #627, #628, #629, #630, #652, #653, #654, #656, #691, #692, #693, #694, #928, #929 | use #927 as the readiness gate; keep #693/#694 as implementation slices | Start with the readiness matrix before backend replacement work. Do not remove generated Rust until #694 is assigned and the readiness gate is green. |
| Rust bootstrap removal / self-hosting | #721 | #559, #562, #643, #644, #645, #682, #684, #687, #717, #719, #930, #931, #932 | supersede older phase duplicates; use #930-#932 as the current execution slices | Keep work tied to the current Phase-J family. Do not remove Rust or Cargo behavior unless the assigned issue explicitly permits it and `make rust-exit-readiness` is green. |
