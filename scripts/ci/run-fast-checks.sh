...
python3 "$script_repo_root/scripts/ci/test-check-runtime-observability-v1.py" --root "$repo_root"
python3 "$script_repo_root/scripts/ci/check-runtime-observability-v1.py" --root "$repo_root"
