...
stage1-io-reactor-v1-test:
	...
	cargo test --manifest-path stage1/Cargo.toml -p axiomc --test schema_metadata io_reactor_schema_enforces_evidence_promotion_boundaries --locked
